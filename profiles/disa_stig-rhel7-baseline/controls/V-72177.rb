...
POSTQUEUE_AUDIT_FIELDS = attribute(
  'postqueue_audit_fields',
  default: ['path=/usr/sbin/postqueue', 'perm=x', 'auid>=1000', 'auid!=-1'],
...
The audit daemon must be restarted for the changes to take effect."
  ...
  describe auditd_rules2.file("#{path}") do
    ...
    its('fields_nokey.flatten') { should match_array POSTQUEUE_AUDIT_FIELDS }
  end
end
