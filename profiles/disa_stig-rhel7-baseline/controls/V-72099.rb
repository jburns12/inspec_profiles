...
FCHOWN_AUDIT_LINE_32 = attribute(
  ...
  default: '^-a always,exit -F arch=b32 .*-S fchown .*-F auid>=1000 -F auid!=4294967295 -k \S+\n?$',
...
FCHOWN_AUDIT_LINE_64 = attribute(
  ...
  default: '^-a always,exit -F arch=b64 .*-S fchown .*-F auid>=1000 -F auid!=4294967295 -k \S+\n?$',
