...
FSETXATTR_AUDIT_LINE_32 = attribute(
  ...
  default: '^-a always,exit -F arch=b32 .*-S fsetxattr .*-F auid>=1000 -F auid!=4294967295 -k perm_mod',
...
FSETXATTR_AUDIT_LINE_64 = attribute(
  ...
  default: '^-a always,exit -F arch=b64 .*-S fsetxattr .*-F auid>=1000 -F auid!=4294967295 -k perm_mod',
